...
$date = date('Y-m-d');
	...
	federal_individual_tax_form($id, $street, $aptNo, $city, $state, $zipcode, $occupation, $wages, $filing_status, $sp_f_name, $sp_m_name, $sp_l_name, $sp_ssn, $signature, $sig_date);
	if ($filing_status == 4)
		federal_individual_tax_form_dependents($id, $dep_f_name, $dep_l_name, $dep_ssn, $dep_relation);
